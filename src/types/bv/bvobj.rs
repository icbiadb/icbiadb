...
impl<'a> BvObj<'a> {
	...
	pub fn from_raw(t: &'a Vec<u8>, v: &'a Vec<u8>) -> Self {
		BvObj {
			type_name: BvStr::new(t.as_slice()),
			raw: ByteSlice::new(v.as_slice())
		}
	}
